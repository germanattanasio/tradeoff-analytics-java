				...
				<div class="row top-nav">
					<div class="col-lg-12">
						<a
							...
							class="left">Learn more about this service</a><a
							href="https://github.com/watson-developer-cloud/tradeoff-analytics-nodejs"
							class="right fork">Fork</a><a
							href="mailto:watsondevelopercloud@ibm.com" class="right">Contact
							Us</a><a href="https://developer.ibm.com/answers/smartspace/watson/"
							class="right">Watson Community</a>
					</div>
				</div>
